...
const defaultMeta = {
  title: 'Next User Auth',
  siteName: 'Next User Auth',
  description: 'Next User Auth Website to Conquer The WORLD',
  /** Without additional '/' on the end, e.g. https://allam-taju.vercel.app */
  url: 'https://unbreakable-nextjs-auth.vercel.app',
  type: 'website',
  robots: 'follow, index',
  /**
   ...
   */
  image: 'https://unbreakable-nextjs-auth.vercel.app/images/large-og.png',
};
